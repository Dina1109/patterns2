...
public class AuthTest {
    ...
    @Test
    @DisplayName("Should successfully login with active registered user")// зарегистрированный активный пользователь
    ...
    @Test
    @DisplayName("Should get error message if login with not registered user") //незарегистрированный пользователь
